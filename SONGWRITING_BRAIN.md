# The Songwriting Brain — Curriculum (DRAFT for founder review)

> This document defines what the app must UNDERSTAND before it writes a single line.
> It is written in plain language so the founder can mark it up directly.
> Status: SKELETON — founder is actively adding requirements. Nothing built from this yet.

---

## Layer 1 — What a song IS, and the job of every section
...
## Layer 3 — Musical craft (the founder's list; each becomes concrete rules)
...
## Layer 4 — Composing for genre (how thinking changes, not just sounds)

- Genre changes the composition decisions: phrasing length, rhyme density, subject treatment,
  vocal space (runs/adlibs), rhythmic feel of the words, section conventions.

**PRIORITY GENRES (founder-set, in order — these must be DEEPLY right first):**
...
1. Understand the story/feeling (the user's words, arriving whole).
2. Find the core emotion + the turn (what changes in this song?).
3. Choose the title/hook everything builds toward.
...
- **Valid Suno tags (the only ones the machine reads — founder-editable):** [Intro], [Verse], [Pre-Chorus], [Chorus], [Post-Chorus], [Hook], [Refrain], [Bridge], [Break], [Breakdown], [Interlude], [Outro], [Instrumental], [Ad-Lib Section], [Male Vocal], [Female Vocal], [Duet], [Choir], [Whispered], [Spoken], [Belting], [Falsetto], [Crooning], [Harmonies], [Vocal Run], [Call and Response], [Choir enters], [Build], [Build Up], [Drop], [Crescendo], [Big Finish], [Soft], [Quiet], [Guitar Solo], [Piano Solo], [Sax Solo], [Bass Solo], [Instrumental Break], [Instrumental Bridge], [Instrumental Intro], [Instrumental Outro], [Vamp], [Outro Vamp], [Final Vamp], [Guitar Riff], [Vocal Runs], [Runs], [Groove]

---

## OPEN — founder input needed

- "And more": items still to be added by the founder.
- The founder's own songwriting philosophy in his words (beliefs, pet peeves, rules of thumb, what amateurs get wrong).
- Which genres matter most, in order.
- How this knowledge should be built into the app (to be designed AFTER the curriculum is approved — no building until then).
