...
const TermsAndPrivacy: React.FC<TermsAndPrivacyProps> = ({ onBack }) => {
  return (
    <div className="app-shell min-h-screen text-slate-300 p-4 md:p-12 animate-fade-in overflow-y-auto safe-top safe-bottom safe-x">
      <div className="max-w-4xl mx-auto pb-20">
        <button 
          onClick={onBack} 
          className="mb-10 text-slate-500 active:text-white transition-all font-black text-sm uppercase tracking-widest flex items-center gap-2 group"
        >
          ...
          <section>
            ...
            <div className="space-y-8 text-sm md:text-base leading-relaxed text-slate-400 font-medium">
              ...
              <div className="glass-panel p-6 rounded-3xl">
                <strong className="text-cyan-200 block mb-2 uppercase tracking-wide text-xs">3. Content Ownership</strong>
                <p className="text-cyan-100 font-bold">You retain full, exclusive ownership of all lyrics and content generated using this application. Song Ghost claims no intellectual property rights over the output created by your inputs.</p>
              </div>
