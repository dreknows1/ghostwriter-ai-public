    ...
    <AnimatePresence>
      <motion.div
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse at 50% 40%, rgba(168,85,247,0.50), transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(236,72,153,0.25), transparent 50%), linear-gradient(160deg, #0a0318, #110a2a 45%, #1a1045)',
