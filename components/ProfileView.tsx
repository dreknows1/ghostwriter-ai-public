        ...
        <div className="flex-grow">
                        ...
                        {songs.length > 0 ? (
                            <div className="space-y-4">
                                {songs.slice(0, 3).map(song => (
                                    <div key={song.id} className="glass-panel bg-[#1e1250]/70 p-6 rounded-3xl flex items-center justify-between">
                    ...
                    <div className="space-y-8">
                        <div className="grid grid-cols-2 gap-8">
                             <div className="col-span-2">
                                ...
                                <input type="text" value={editData.display_name} onChange={e => setEditData({...editData, display_name: e.target.value})} className="w-full bg-[#1e1250] border border-slate-800 p-4 rounded-2xl text-white text-base outline-none focus:border-violet-500 transition-all" />
                             </div>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="flex-grow">
                                         <input 
                                            ...
                                            className="w-full bg-[#1e1250] border border-slate-800 p-3 rounded-2xl text-sm text-slate-300 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-black file:uppercase file:bg-slate-800 file:text-white hover:file:bg-slate-700 cursor-pointer"
                                         />
                             ...
                             <div className="col-span-2">
                                ...
                                <select 
                                    ...
                                    className="w-full bg-[#1e1250] border border-slate-800 p-4 rounded-2xl text-white text-base outline-none focus:border-violet-500 transition-all appearance-none cursor-pointer"
                                >
                             ...
                             <div className="col-span-2">
                                ...
                                <input type="text" value={editData.preferred_vibe} onChange={e => setEditData({...editData, preferred_vibe: e.target.value})} className="w-full bg-[#1e1250] border border-slate-800 p-4 rounded-2xl text-white text-base outline-none focus:border-violet-500 transition-all" />
                             </div>
                             <div className="col-span-2">
                                <label className="block text-sm font-black uppercase tracking-widest text-slate-500 mb-3">Bio / Manifesto</label>
                                <textarea value={editData.bio} onChange={e => setEditData({...editData, bio: e.target.value})} className="w-full h-32 bg-[#1e1250] border border-slate-800 p-4 rounded-2xl text-white text-base outline-none focus:border-violet-500 transition-all resize-none" />
                             </div>
                        </div>
            ...
            {activeTab === 'wallet' && (
                <div className="animate-fade-in">
                    ...
                    <div className="bg-[#1e1250] border border-slate-800 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 mb-12 flex items-center justify-between relative overflow-hidden gap-4">
                    ...
                    <div className="bg-[#1a0e3a] border border-slate-800 rounded-3xl overflow-hidden">
                ...
                <div className="animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {songs.length > 0 ? songs.map(song => (
                             <div key={song.id} className="group bg-[#1a0e3a] border border-slate-800 p-4 md:p-6 rounded-3xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 hover:border-violet-500/30 transition-all">
                                 <div className="flex items-center gap-6">
