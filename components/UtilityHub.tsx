    ...
    <div className="max-w-3xl mx-auto pt-6 md:pt-10 pb-20 px-4 animate-fade-in">
      ...
      {section === "invite" && (
        <div className="glass-panel rounded-3xl p-6 md:p-8 space-y-5">
          ...
          <div className="bg-[#160d38] border border-slate-800 rounded-2xl p-4 break-all text-cyan-400 font-mono">{inviteLink || "Loading..."}</div>
      ...
      {section === "earn" && (
        <div className="glass-panel rounded-3xl p-6 md:p-8 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-[#160d38] border border-slate-800 rounded-2xl p-4">
      ...
      {section === "feedback" && (
        <div className="glass-panel rounded-3xl p-6 md:p-8 space-y-4">
          ...
          <textarea
            ...
            className="w-full h-40 bg-[#160d38] border border-slate-800 rounded-2xl p-4 text-white outline-none"
          />
          <button
            onClick={() => {
