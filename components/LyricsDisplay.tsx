      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8 flex flex-col gap-8">
            <div className={`glass-panel-strong rounded-[2rem] md:rounded-[3.5rem] flex flex-col shadow-2xl ring-1 ring-white/5 min-h-[900px] md:min-h-[1200px] relative studio-container overflow-hidden`}>
                ...
                <div className="bg-[#251860]/60 px-4 md:px-10 py-5 md:py-7 border-b border-slate-800 flex justify-between items-center relative z-40 gap-3">
                ...
                <div className="p-4 md:p-10 pb-4 md:pb-6 border-b border-slate-800/50 bg-slate-900/10 relative z-40">
                   ...
                   <textarea value={parsed.prompt} onChange={(e) => addToHistory(`Title: ${parsed.title}\n\n### SUNO Prompt\n${e.target.value}\n\n### Lyrics\n${parsed.lyrics}`)} className="w-full bg-[#251860] border border-slate-800/60 rounded-3xl p-6 text-sm font-mono text-white/70 focus:border-[#6366F1] outline-none resize-none transition-all" rows={4} />
                </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
              <div className="flex flex-col">
                  ...
                  {questionnaireItems.length > 0 && (
                    <div className="mb-6 rounded-2xl border border-indigo-900/40 bg-[#251860] p-4">
                      <div className="flex items-center justify-between mb-2">
              ...
              <div className="bg-[#251860] border border-slate-800 p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-xl">
                  ...
                  <div className={`${artAspect === "9:16" ? "aspect-[9/16]" : artAspect === "1:1" ? "aspect-square" : "aspect-[16/9]"} w-full bg-[#1e1248] rounded-[2rem] flex items-center justify-center text-slate-800 border-2 border-dashed border-slate-800/40 mb-5 overflow-hidden relative`}>
